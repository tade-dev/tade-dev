...
**Mobile & Frontend** · Swift · SwiftUI · Flutter · Dart · TypeScript
**Apple Platform** · SwiftData · CloudKit · StoreKit 2 · WidgetKit · WatchKit · ARKit · Core ML
**Backend & Services** · Node.js · Firebase · PostgreSQL
**DevOps & Tooling** · GitHub Actions · Fastlane · CI/CD · RevenueCat · Git
...
**[HavenGuide](https://havenguide.xyz)** — Faith companion app that combines Scripture with AI to deliver personalised daily devotions. Guided reflections, contextual insights, and a calm, distraction-free reading experience.

**[Foodnify](https://foodnify.com)** — AI-powered food platform for recipe sharing, homemade meal ordering, and chef/caterer booking. Available on the App Store and Google Play across multiple regions.

---

### Open Source

**[SafeSpaceAR](https://github.com/tade-dev/SafeSpaceAR)** — ARKit + Core ML iOS app that detects household dangers in real time and surfaces safety warnings as AR overlays. Built for the Apple Swift Student Challenge 2026.

**[PizzaTracker](https://github.com/tade-dev/PizzaTracker)** — Live Activities and Dynamic Island prototype built with ActivityKit and WidgetKit.
...
**[claude-telegram-bot](https://github.com/tade-dev/claude-telegram-bot)** — Telegram bot powered by Claude AI with GitHub integration.
